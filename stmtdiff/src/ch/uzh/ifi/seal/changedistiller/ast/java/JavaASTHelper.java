...
public class JavaASTHelper implements ASTHelper<JavaStructureNode> {
    ...
    private Node createRootNode(JavaStructureNode node, ASTNode astNode) {
        Node root = new Node(fASTHelper.convertNode(astNode), node.getFullyQualifiedName(), astNode);
    ...
    List<ASTNode> astnodesinhunks = new LinkedList<ASTNode>();
    ...
    public Scanner getScanner(){
    	return fCompilation.getScanner();
    }
    
    public JavaCompilation getCompilation(){
    	return fCompilation;
    }
