...
public class JavaMethodBodyConverter extends ASTVisitor {
        ...
        if ((node.catchBlocks != null) && (node.catchBlocks.length > 0)) {
            ...
            for (int i = 0; i < node.catchArguments.length; i++) {
                ...
                push(
                        ...
                        node.catchBlocks[i].sourceEnd, node.catchArguments[i]
                        );
    ...
    public boolean visit(WhileStatement whileStatement, BlockScope scope) {
        ...
        push(
                ...
                whileStatement.sourceEnd, whileStatement);
    ...
    private void push(EntityType label, String value, int start, int end, ASTNode astnode) {
        Node n = new Node(label, value.trim(), astnode);
        n.setEntity(new SourceCodeEntity(value.trim(), label, new SourceRange(start, end), astnode));
